...
const About = () => {
    return (
        <section id="about" className="mt-10 py-8 flex-center flex-col">
            <h1 className="text-2xl font-bold text-center text-white md:text-4xl">About Codersyug🚀</h1>
            <div className="grid max-w-screen-xl px-4 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div className="mr-auto place-self-center lg:col-span-7 mt-10">
                    <h1 className="max-w-3xl bg-gradient-to-r from-yellow-300 to-green-600 bg-clip-text text-transparent mb-2 text-xl font-extrabold tracking-tight leading-none md:text-2xl xl:text-3xl">
            ...
            <div className="flex items-center justify-center frame w-full max-w-5xl flex-col paddings py-16 sm:px-8">
                <div className="sm-box sm-box-1 bg-gray-800"></div>
                <div className="sm-box sm-box-2 bg-gray-800"></div>
                <div className="sm-box sm-box-3 bg-gray-800"></div>
                <div className="sm-box sm-box-4 bg-gray-800"></div>
                <div className="sm-box sm-box-5 bg-gray-800"></div>
                <div className="sm-box sm-box-6 bg-gray-800"></div>
                <div className="sm-box sm-box-7 bg-gray-800"></div>
                <div className="sm-box sm-box-8 bg-gray-800"></div>
                <div className="flex flex-col gap-12 p-10 max-sm:px-6 max-sm:py-0 text-center">
                    <Link href={"https://github.com/Aestheticsuraj234/codersyug"} target="_blank" className="sm:heading2 heading3 max-w-xl text-white cursor-pointer">
