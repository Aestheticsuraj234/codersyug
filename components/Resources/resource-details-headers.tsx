...
const ResourceDetailsHeader = ({
    ...
    return (
        <div className='flex-center flex-col gap-3 sm:gap-5 mb-10 '>
            ...
            <h1 className="heading3 sm:heading2 w-full text-center tracking-[-0.64px]">Elevate Your Skills to the Top 1% in <span className="text-gradient_blue">{category} </span>Development in Just One {type}</h1>
